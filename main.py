...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.username = name
        self.name_lbl = CTkLabel(self,text="Hi, " + self.username, text_color="purple")
        self.name_lbl.pack()
        ...
        self.send_button = CTkButton(self.bottom_row, text="8",
                                     width=50,height=40, command=self.send_message)
    ...
    def connect(self):
        try:
            ...
            self.sock.connect(("6.tcp.eu.ngrok.io", 10580))
